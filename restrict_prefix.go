...
// RestrictPrefix is middleware that restricts
// requests where any portion of the URI matches
// a given prefix.
...
// Validate the prefix from the module's configuration,
// setting the default prefix "." if necessary.
